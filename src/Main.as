...
public class Main extends MovieClip {
    ...
    public function Main() {
        ...
        this.shapeForIllumination.graphics.drawRect(0, 0, Main.instance.width, Main.instance.height);
        this.shapeForIllumination.graphics.endFill();
    }
    ...
    public function setItemSelected(item:Item):void{
        ...
        if (this.itemSelected) this.itemSelected.unselectItem();
    ...
    public function playLevel(levelNumber:int):void{
        ...
        for each(var level:Level in levelArray){
            if (level is levelRef){
                ...
                level.loadStage();
                removeChild(level);
                if (this.shapeForIllumination.stage) setChildIndex(this.shapeForIllumination, numChildren-1);
            }
        }
    }
